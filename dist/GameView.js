...
class GameView {
     ...
     */
    draw(model, currentTime, background = []) {
     ...
     */
    isDrawable(unit) {
        return typeof unit.draw === "function";
    }
    /**
     ...
     */
    drawGameOver(model) {
        this.drawEndScreen("GAME OVER", "The robots stole the weapons!", model.score, "red");
    }
    /**
     ...
     */
    drawVictory(model) {
        this.drawEndScreen("YOU WIN!", "The factory is safe!", model.score, "lime");
    }
    /**
     ...
     */
    drawEndScreen(title, message, score, color) {
        this._ctx.save();
