...
class ScoutTowerModel extends TowerModel {
    ...
    attack(units) {
        ...
        return new Projectile(this.centerX - projectileSize / 2, this.centerY - projectileSize / 2, projectileSize, projectileSize, this._damage, 7, target, Projectile.TYPE_SINGLE_TARGET, 0);
    }
}
